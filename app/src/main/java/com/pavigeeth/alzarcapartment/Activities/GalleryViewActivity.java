...
import com.pavigeeth.alzarcapartment.Adapter.GalleryAdapter;
...
public class GalleryViewActivity extends AppCompatActivity {
    ...
    private static final String COLLEGE_KEY = "EVENTID";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        COLLEGE_IMAGES_NODE = getResources().getString(R.string.firebase_database_node_event_images_detail);
        ...
        final PermissionListener permissionlistener = new PermissionListener() {
            ...
            public void onPermissionGranted() {
                TedBottomPicker tedBottomPicker = new TedBottomPicker.Builder(GalleryViewActivity.this)
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TedPermission.with(GalleryViewActivity.this)
    ...
    private void uploadImage(Uri uri) {
        StorageReference filePath = storageRef.child(COLLEGE_IMAGES_NODE).child(collegeId).child(UUID.randomUUID().toString() + "");
    ...
    private void updateDatabaseWithImage(final String url) {
        ...
        mCollegeFileRef.child(collegeId).child(key).setValue(imagesDetail);
    }
    ...
    private void setRecyclerView() {
        gridLayoutManager = new GridLayoutManager(GalleryViewActivity.this, getSpanCount());
...
//        recyclerView.setAdapter(mAdapter);
    ...
    private void loadfiles() {
        ...
        mCollegeFileRef.child(collegeId).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!imagesDetailList.isEmpty()) {
                    ...
                    recyclerView.setAdapter(new GalleryAdapter(imagesDetailList, GalleryViewActivity.this));
            ...
            public void onCancelled(DatabaseError databaseError) {
                //hideProgressView();
                Toast.makeText(GalleryViewActivity.this, "Something went wrong while searching", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void viewImage(String URL) {
        Intent intent = new Intent(GalleryViewActivity.this, ViewImageActivity.class);
    ...
    private void makeToast(String message) {
        Toast.makeText(GalleryViewActivity.this, message, Toast.LENGTH_SHORT).show();
    }
